  ...
  return (
    <section className="mb-5">
      <button
        ...
        className="flex items-center gap-2.5 px-5 mb-2.5 group w-full"
      >
        <img
          src={group.flag}
          alt={group.country}
        ...
        <span className="text-[11px] text-muted-foreground">{group.channels.length}</span>
        <ChevronRight size={16} className="text-muted-foreground group-hover:text-primary transition-colors" />
      </button>
      <div className="flex gap-3 overflow-x-auto overscroll-x-contain px-5 pb-2 scrollbar-hide">
